    ...
    <div class="bgbanner">
     ...
     <!---end banner--->
      <!---bugatti--->  
        ...
        <h4 class="mb-4 text-light fs-3">BUGATTI</h4>
          <div class="row justify-content-center">
              <?php
                $sql = "select * from bugatti_tbl WHERE id = 1";
               ...
               $sql = "select * from bugatti_tbl WHERE id = 2";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 5";
               $result = mysqli_query($conn, $sql);
               if(mysqli_num_rows($result) > 0){
                 while($row = mysqli_fetch_assoc($result)){
                         echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
              ...
              $sql = "select * from bugatti_tbl WHERE id = 4";
              $result = mysqli_query($conn, $sql);
              if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){
                        echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
      ...
      <div class="container mt-5">
          <div class="row justify-content-center">
              <?php
                $sql = "select * from bugatti_tbl WHERE id = 6";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 7";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 8";
               $result = mysqli_query($conn, $sql);
               if(mysqli_num_rows($result) > 0){
                 while($row = mysqli_fetch_assoc($result)){
                         echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
              ...
              $sql = "select * from bugatti_tbl WHERE id = 9";
              $result = mysqli_query($conn, $sql);
              if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){
                        echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
      ...
      <div class="container mt-5">
          <div class="row justify-content-center">
              <?php
                $sql = "select * from bugatti_tbl WHERE id = 10";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 11";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 12";
               $result = mysqli_query($conn, $sql);
               if(mysqli_num_rows($result) > 0){
                 while($row = mysqli_fetch_assoc($result)){
                         echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
              ...
              $sql = "select * from bugatti_tbl WHERE id = 13";
              $result = mysqli_query($conn, $sql);
              if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){
                        echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
      ...
      <!---end bugatti_2--->  
       ...
       <div class="container mt-5">
          <div class="row justify-content-center">
              <?php
                $sql = "select * from bugatti_tbl WHERE id = 14";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 15";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 16";
               $result = mysqli_query($conn, $sql);
               if(mysqli_num_rows($result) > 0){
                 while($row = mysqli_fetch_assoc($result)){
                         echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
              ...
              $sql = "select * from bugatti_tbl WHERE id = 17";
              $result = mysqli_query($conn, $sql);
              if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){
                        echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
      ...
      <!---end bugatti_3--->  
       ...
       <div class="container mt-5">
          <div class="row justify-content-center">
              <?php
                $sql = "select * from bugatti_tbl WHERE id = 18";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 19";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 20";
               $result = mysqli_query($conn, $sql);
               if(mysqli_num_rows($result) > 0){
                 while($row = mysqli_fetch_assoc($result)){
                         echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
              ...
              $sql = "select * from bugatti_tbl WHERE id = 21";
              $result = mysqli_query($conn, $sql);
              if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){
                        echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
      ...
      <!---end bugatti_4--->  
       ...
       <div class="container mt-5">
          <div class="row justify-content-center">
              <?php
                $sql = "select * from bugatti_tbl WHERE id = 22";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 23";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               $sql = "select * from bugatti_tbl WHERE id = 24";
               $result = mysqli_query($conn, $sql);
               if(mysqli_num_rows($result) > 0){
                 while($row = mysqli_fetch_assoc($result)){
                         echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
              ...
              $sql = "select * from bugatti_tbl WHERE id = 25";
              $result = mysqli_query($conn, $sql);
              if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)){
                        echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
