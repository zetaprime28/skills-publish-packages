      ...
      <div class="container mt-5">
          <h4 class="mb-4 text-light fs-3">NISSAN (R34)</h4>
            <div class="row justify-content-center">
                <?php
                  $sql = "select * from cars_tbl WHERE id = 4";
                ...
                $sql = "select * from cars_tbl WHERE id = 10";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 2";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 25";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                <div class="d-flex justify-content-center mt-4">
                  <div><a href="carsr34.php"><button class="btn btn-outline-danger text-warning px-5">See More...</button></a></div>
                </div>  
        </div>
        <!---end r34---> 
        <!---r35--->  
        <div class="container mt-5">
          <h4 class="mb-4 text-light fs-3">NISSAN (R35)</h4>
            <div class="row justify-content-center">
                <?php
                  $sql = "select * from cars_tbl WHERE id = 3";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 35";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 12";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 27";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
               ...
               <div class="d-flex justify-content-center mt-4">
                  <div><a href="carsr35.php"><button class="btn btn-outline-danger text-warning px-5">See More...</button></a></div>
                </div>  
        </div>
        <!---end r35--->  
        <!---lamborghini--->  
        <div class="container mt-5">
          <h4 class="mb-4 text-light fs-3">LAMBORGHINI</h4>
            <div class="row justify-content-center">
                <?php
                  $sql = "select * from cars_tbl WHERE id = 13";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 14";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 15";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 28";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
            ...
            <div class="d-flex justify-content-center mt-4">
                  <div><a href="lamborghini.php"><button class="btn btn-outline-danger text-warning px-5">See More...</button></a></div>
                </div>  
        </div>
        <!---end lamborghini--->  
        <!---ferrari--->  
        <div class="container mt-5">
          <h4 class="mb-4 text-light fs-3">FERRARI</h4>
            <div class="row justify-content-center">
                <?php
                  $sql = "select * from cars_tbl WHERE id = 16";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 17";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 18";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 29";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
            ...
            <div class="d-flex justify-content-center mt-4">
                  <div><a href="ferrari.php"><button class="btn btn-outline-danger text-warning px-5">See More...</button></a></div>
                </div>  
        </div>
        <!---end ferrari--->  
        <!---bugatti--->  
        <div class="container mt-5">
          <h4 class="mb-4 text-light fs-3">BUGATTI</h4>
            <div class="row justify-content-center">
                <?php
                  $sql = "select * from cars_tbl WHERE id = 19";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 20";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 21";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 30";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
            ...
            <div class="d-flex justify-content-center mt-4">
                  <div><a href="bugatti.php"><button class="btn btn-outline-danger text-warning px-5">See More...</button></a></div>
                </div>  
        </div>
        <!---end bugatti--->  
        <!---bmw--->  
        <div class="container mt-5">
          <h4 class="mb-4 text-light fs-3">BMW</h4>
            <div class="row justify-content-center">
                <?php
                  $sql = "select * from cars_tbl WHERE id = 22";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 23";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                            echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 24";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
                ...
                $sql = "select * from cars_tbl WHERE id = 33";
                $result = mysqli_query($conn, $sql);
                if(mysqli_num_rows($result) > 0){
                  while($row = mysqli_fetch_assoc($result)){
                          echo '<div class="col  border border-danger p-3 me-2 text-white shadow-lg rounded-3">';
            ...
            <div class="d-flex justify-content-center mt-4">
                  <div><a href="bmw.php"><button class="btn btn-outline-danger text-warning px-5">See More...</button></a></div>
                </div>  
        </div>
        <!---end bmw---> 
        <!-- Footer Section -->
